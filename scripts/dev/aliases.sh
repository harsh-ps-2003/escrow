...
alias fedimint-cli-buyer="env FM_CLIENT_DIR=\$FM_DATA_DIR/client-buyer fedimint-cli"
alias fedimint-cli-seller="env FM_CLIENT_DIR=\$FM_DATA_DIR/client-seller fedimint-cli"
alias fedimint-cli-arbiter="env FM_CLIENT_DIR=\$FM_DATA_DIR/client-arbiter fedimint-cli"
